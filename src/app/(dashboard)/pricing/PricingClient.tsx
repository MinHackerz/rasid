...
import { Check, Loader2, Sparkles, Zap, Building2, Crown, Infinity as InfinityIcon, AlertCircle, Star } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50/50 p-6 md:p-12">
            <div className="relative z-10 max-w-7xl mx-auto space-y-12">
                ...
                <motion.div
                    ...
                    className={cn(
                        "relative overflow-hidden rounded-2xl border bg-white shadow-sm transition-all hover:shadow-md",
                        currentPlan === 'FREE' ? "border-emerald-500 ring-1 ring-emerald-500" : "border-neutral-200"
                    )}
                >
                        ...
                        <div className="w-full md:w-auto">
                            {currentPlan === 'FREE' ? (
                                ...
                                <Button
                                    ...
                                    className="w-full md:w-auto bg-white text-neutral-900 border border-neutral-200 hover:bg-neutral-50 h-10 px-8 rounded-lg font-semibold"
                                >
                                    {loadingPlan === 'FREE' ? <Loader2 className="w-5 h-5 animate-spin" /> : "Downgrade to Free"}
                                </Button>
                            )}
                        </div>
                    </div>
                ...
                >
                    ...
                    <div className="lifetime-border relative rounded-2xl p-[2px]">
                        ...
                        <div className={cn(
                            ...
                            currentPlan === 'LIFETIME' && "ring-2 ring-emerald-500"
                        )}>
                                ...
                                <div className="w-full md:w-auto flex flex-col gap-2">
                                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
                                        <Button
                                            ...
                                            disabled={loadingPlan !== null || (currentPlan === 'LIFETIME' && !hasPendingCancellation)}
                                            className={cn(
                                                "w-full md:w-auto h-12 px-10 rounded-xl font-bold text-base transition-all duration-300",
                                                currentPlan === 'LIFETIME' && !hasPendingCancellation
                    ...
                    <AnimatePresence mode="wait">
                        {isAnnual ? (
                            <motion.div
                                ...
                                className="flex items-center gap-2 text-xs font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 px-4 py-2 rounded-full shadow-sm shadow-emerald-100"
                            >
                                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                                You're saving 20% — billed annually
                            </motion.div>
                        ) : (
                            <motion.div
                                key="monthly-hint"
