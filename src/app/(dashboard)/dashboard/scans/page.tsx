...
export default async function PendingScansPage() {
    ...
    return (
        <PremiumFeatureGuard
            isAllowed={isAllowed}
            featureName="OCR Scans (Digitization)"
            description={`Convert handwritten or scanned invoices to digital format. Your plan includes ${PLANS[currentPlanKey]?.limits.ocr || 0} OCR scans per month. Upgrade to unlock this feature!`}
        >
